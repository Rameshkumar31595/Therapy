...
(function () {
  ...
  var TE = {
    ...
    "bk.sessionNote": "హోమ్ సర్వీస్ కేవలం సిరోఅభ్యంగ & పాదాభ్యంగ కాంబో, అభ్యంగ ఫుల్ బాడీ, అభ్యంగ ఫుల్ బాడీ ఎక్స్‌టెండెడ్ వెర్షన్ కోసం మాత్రమే అందుబాటులో ఉంది. మసాజ్ థెరపీ సెంటర్‌లో అన్ని థెరపీలు అందుబాటులో ఉంటాయి.",
    ...
    "bk.steam": "హాట్ స్టీమ్ బాత్ జోడించండి <strong>(ఉచితం)</strong>",
