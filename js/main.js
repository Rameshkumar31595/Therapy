...
(function () {
  ...
  var TE = {
    ...
    "hero.t2": "మసాజ్ థెరపీ",
    "hero.t3": "మా క్లినిక్‌లో",
    "hero.sub": "నరసరావుపేటలోని మా క్లినిక్‌లో కేరళ సంప్రదాయ మసాజ్ థెరపీలు, వెల్‌నెస్ చికిత్సలు అనుభవించండి. సర్టిఫైడ్ థెరపిస్ట్ కపుల్ ప్రొఫెషనల్, ప్రశాంత వాతావరణంలో సేవలు అందిస్తారు.",
    ...
    "chip.door": "క్లినిక్ ఆధారిత చికిత్సలు",

    "about.badge": "సుశ్రుత<br/><em>సంప్రదాయం</em>",
    "about.eyebrow": "మా గురించి",
    "about.title": "కేరళ వెల్‌నెస్ సంప్రదాయం,<br/><span class=\"gold-italic\">నరసరావుపేటలోని మా క్లినిక్‌లో</span>",
    "about.lead": "సుశ్రుత ఒక సర్టిఫైడ్ థెరపిస్ట్ కపుల్. ప్రొఫెషనల్ కేరళ మసాజ్ థెరపీని నరసరావుపేటలోని మా క్లినిక్‌లో అందిస్తారు.",
    ...
    "svc.intro": "ప్రతి థెరపీ మా క్లినిక్‌లో, వేడి హెర్బల్ నూనెలు, శుభ్రమైన లినెన్లతో, సంప్రదాయ కేరళ పద్ధతిలో.",
    ...
    "why.c7t": "ప్రశాంతమైన క్లినిక్",
    "why.c7d": "ప్రశాంతమైన, పరిశుభ్రమైన క్లినిక్. వేడి నూనెలు, శుభ్రమైన లినెన్లు, నైపుణ్యం అన్నీ సిద్ధంగా ఉంటాయి. మీరు వచ్చి హాయిగా రిలాక్స్ అవ్వండి.",
    ...
    "time.eyebrow": "మమ్మల్ని సందర్శించే సమయాలు",
    "time.title": "ప్రతి రోజూ అందుబాటులో,<br/><span class=\"gold-italic\">మీ సౌకర్యం ప్రకారం</span>",
    "time.para": "ఉదయం రిలాక్సేషన్ లేదా సాయంత్రం విశ్రాంతి కోసం, నరసరావుపేట, పల్నాడు జిల్లాలోని మా క్లినిక్‌కు వారమంతా రండి.",
    ...
    "bk.session": "సెషన్ రకం <em>*</em>",
    "bk.sessionPh": "ఇంటి వద్ద లేదా క్లినిక్ ఎంచుకోండి…",
    "bk.sessionNote": "ఇంటి వద్ద సేవలో Padaabhyanga, Abhyanga, Abhyanga Extended మాత్రమే అందుబాటులో ఉంటాయి. క్లినిక్‌లో అన్ని థెరపీలు అందుబాటులో ఉంటాయి.",
    ...
    "con.sub": "ఒక్క మెసేజ్ చాలు. మీకు కావాల్సిన థెరపీ, సమయం చెప్పండి. నరసరావుపేటలోని మా క్లినిక్‌కు వచ్చి హాయిగా విశ్రాంతి పొందండి.",
    ...
    "con.door": "మా క్లినిక్‌ను సందర్శించండి — వాక్-ఇన్ & అపాయింట్‌మెంట్లు స్వాగతం",
    "con.directions": "డైరెక్షన్స్ పొందండి",

    "foot.line": "అసలైన కేరళ ఆయుర్వేద థెరపీ, నరసరావుపేటలోని మా క్లినిక్‌లో.",
