...
(function () {
  ...
  var TE = {
    ...
    "hero.t2": "మసాజ్ థెరపీ",
    "hero.t3": "క్లినిక్‌లో<br/>లేదా మీ ఇంటిలో",
    "hero.sub": "నరసరావుపేటలోని మా క్లినిక్‌లో కేరళ సంప్రదాయ మసాజ్ థెరపీలు అనుభవించండి. ఎంచుకున్న కొన్ని థెరపీలకు హోమ్ సర్వీస్ కూడా అందుబాటులో ఉంది. సర్టిఫైడ్ థెరపిస్ట్ కపుల్ ప్రొఫెషనల్, ప్రశాంత వాతావరణంలో సేవలు అందిస్తారు.",
    ...
    "chip.door": "క్లినిక్ & హోమ్ సర్వీస్",

    "about.badge": "సుశ్రుత<br/><em>సంప్రదాయం</em>",
    "about.eyebrow": "మా గురించి",
    "about.title": "కేరళ వెల్‌నెస్ సంప్రదాయం,<br/><span class=\"gold-italic\">క్లినిక్‌లో & మీ ఇంటిలో</span>",
    "about.lead": "సుశ్రుత ఒక సర్టిఫైడ్ థెరపిస్ట్ కపుల్. నరసరావుపేటలో ప్రొఫెషనల్ కేరళ మసాజ్ థెరపీని క్లినిక్‌లో, ఎంచుకున్న థెరపీలకు మీ ఇంటిలో కూడా అందిస్తారు.",
    ...
    "svc.intro": "ప్రతి థెరపీ మా క్లినిక్‌లో, వేడి హెర్బల్ నూనెలు, శుభ్రమైన లినెన్లతో, సంప్రదాయ కేరళ పద్ధతిలో. ఎంచుకున్న కొన్ని థెరపీలు హోమ్ సర్వీస్‌గా కూడా అందుబాటులో ఉన్నాయి.",
    ...
    "why.c7t": "క్లినిక్ లేదా ఇంటి సౌకర్యం",
    "why.c7d": "ప్రశాంతమైన, పరిశుభ్రమైన క్లినిక్, లేదా ఎంచుకున్న థెరపీలకు మీ ఇంటి సౌకర్యం. వేడి నూనెలు, శుభ్రమైన లినెన్లు, నైపుణ్యం అన్నీ సిద్ధం; మీరు హాయిగా రిలాక్స్ అవ్వండి.",
    ...
    "time.para": "ఉదయం రిలాక్సేషన్ లేదా సాయంత్రం విశ్రాంతి, నరసరావుపేట, పల్నాడు జిల్లాలోని మా క్లినిక్‌లో, లేదా ఎంచుకున్న థెరపీలకు మీ ఇంటి వద్ద. వారమంతా అందుబాటులో.",
    ...
    "bk.sessionNote": "హోమ్ సర్వీస్ కేవలం Padaabhyanga, Abhyanga, Abhyanga Extended కోసం మాత్రమే అందుబాటులో ఉంది. క్లినిక్‌లో అన్ని థెరపీలు అందుబాటులో ఉంటాయి.",
    "bk.therapy": "థెరపీ <em>*</em>",
    "bk.therapyPh": "థెరపీ ఎంచుకోండి…",
    "bk.therapyNote": "కొన్ని థెరపీలకు అవసరమైన పరికరాలు కేవలం క్లినిక్‌లో మాత్రమే అందుబాటులో ఉన్నాయి.",
    "bk.steam": "హెర్బల్ స్టీమ్ జోడించండి <strong>(+₹200)</strong>",
    ...
    "con.sub": "ఒక్క మెసేజ్ చాలు. మీకు కావాల్సిన థెరపీ, సమయం చెప్పండి. నరసరావుపేటలోని మా క్లినిక్‌కు రండి, లేదా ఎంచుకున్న థెరపీలకు హోమ్ సర్వీస్ ఎంచుకోండి, హాయిగా విశ్రాంతి పొందండి.",
    ...
    "con.door": "మా క్లినిక్‌ను సందర్శించండి, లేదా ఎంచుకున్న థెరపీలకు మాత్రమే హోమ్ సర్వీస్ బుక్ చేయండి",
    "con.directions": "డైరెక్షన్స్ పొందండి",

    "foot.line": "అసలైన కేరళ ఆయుర్వేద థెరపీ నరసరావుపేటలో, క్లినిక్‌లో, ఎంచుకున్న థెరపీలకు మీ ఇంటిలో కూడా.",
